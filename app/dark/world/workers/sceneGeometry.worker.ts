...
const regularFontUrl = '/dark/fonts/Urbanist_Regular.typeface.json';
const italicFontUrl = '/dark/fonts/Urbanist_Italic.typeface.json';
    ...
    (async () => {
        try {
            ...
            const shapeTargets: Record<SceneMorphTargetKey, Float32Array> = {
                name: createTextMorphPositions(regularFont, 'AYUSH UPADHYAY', cloudPositions),
