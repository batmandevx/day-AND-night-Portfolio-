    ...
    <group position={[0, -41.5, 12]} rotation={[-Math.PI / 2, 0 ,-Math.PI / 2]}>
      ...
      <group rotation={[0, 0, Math.PI / 2]}>
        ...
        <Float speed={2.2} rotationIntensity={1.6} floatIntensity={2}>
          <mesh position={[isMobile ? 2.2 : 4.4, 2.6, -1.4]}>
            <torusGeometry args={[0.4, 0.13, 16, 48]} />
            <meshStandardMaterial color="white" wireframe />
          </mesh>
        </Float>
        <Float speed={1.7} rotationIntensity={1.2} floatIntensity={2.4}>
          <mesh position={[isMobile ? -2.4 : -4.8, 3, -0.6]}>
            <octahedronGeometry args={[0.42, 0]} />
            <meshStandardMaterial color="#eaf6ff" roughness={0.3} metalness={0.3} />
          </mesh>
        </Float>
